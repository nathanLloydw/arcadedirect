...
define('PERFMATTERS_VERSION', '1.9.0');
...
//plugin classes
require_once plugin_dir_path(__FILE__) . 'inc/classes/Config.php';
require_once plugin_dir_path(__FILE__) . 'inc/classes/Meta.php';
require_once plugin_dir_path(__FILE__) . 'inc/classes/Buffer.php';
require_once plugin_dir_path(__FILE__) . 'inc/classes/Fonts.php';
require_once plugin_dir_path(__FILE__) . 'inc/classes/CDN.php';
require_once plugin_dir_path(__FILE__) . 'inc/classes/Images.php';
require_once plugin_dir_path(__FILE__) . 'inc/classes/Preload.php';
require_once plugin_dir_path(__FILE__) . 'inc/classes/CSS.php';
